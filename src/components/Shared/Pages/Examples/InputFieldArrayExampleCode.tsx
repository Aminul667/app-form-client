...
const zodInputFieldArraySchema = `
...
const inputFieldArrayComponent = `
...
`;
const InputFieldArrayExampleCode = () => {
  return (
    <>
      <div>
        <p>zod schema</p>
        <CodeBlock language="ts" code={zodInputFieldArraySchema} />
      </div>
      <div>
        <p>Input Field Array component</p>
        <CodeBlock language="tsx" code={inputFieldArrayComponent} />
      </div>
    </>
  );
};

export default InputFieldArrayExampleCode;
