...
const WatchFunctionCode = () => {
  return (
    <>
      <div>
        <p>zod schema</p>
        <CodeBlock language="ts" code={zodWatchFunctionSchema} />
      </div>
      <div>
        <p>Watch Function component</p>
        <CodeBlock language="tsx" code={watchFunctionComponent} />
      </div>
    </>
  );
};

export default WatchFunctionCode;
